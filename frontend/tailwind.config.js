  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glowPulse: {
          '0%, 100%': { boxShadow: '0 0 20px rgba(124, 58, 237, 0.10)' },
      ...
      boxShadow: {
        'glow-violet':        '0 0 24px rgba(124, 58, 237, 0.24), 0 0 8px rgba(124, 58, 237, 0.12)',
        'glow-violet-strong': '0 0 48px rgba(124, 58, 237, 0.38), 0 0 20px rgba(124, 58, 237, 0.22)',
        'glow-indigo':        '0 0 24px rgba(99, 102, 241, 0.22)',
        'glow-amber':         '0 0 24px rgba(245, 158, 11, 0.18)',
        'glow-strong':        '0 0 48px rgba(124, 58, 237, 0.32)',
        'card':               '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)',
        'card-hover':         '0 4px 16px rgba(0,0,0,0.08), 0 0 0 1px rgba(124,58,237,0.06)',
        'card-lift':          '0 12px 32px rgba(0,0,0,0.10), 0 2px 8px rgba(0,0,0,0.06)',
        'sidebar':            '1px 0 0 0 rgba(226,232,240,0.8)',
        'header':             '0 1px 0 0 rgba(226,232,240,0.6)',
        'dropdown':           '0 12px 32px rgba(0,0,0,0.10), 0 2px 8px rgba(0,0,0,0.06)',
        'auth-card':          '0 24px 64px rgba(124,58,237,0.12), 0 4px 16px rgba(0,0,0,0.06)',
        'button-primary':     '0 4px 16px rgba(124, 58, 237, 0.32), 0 1px 4px rgba(0,0,0,0.10)',
        'button-primary-hover': '0 8px 24px rgba(124, 58, 237, 0.44), 0 2px 8px rgba(0,0,0,0.10)',
      },
    },
  },
  plugins: [],
