...
export default function SplashScreen({ message = 'Loading…' }: SplashScreenProps) {
  ...
  return (
    <div
      ...
      style={{ background: '#F0FDF4', zIndex: 9999 }}
      role="status"
      aria-label={message}
    >
      ...
      <div
        className="absolute inset-0"
        style={{
          backgroundImage: 'radial-gradient(circle, rgba(22,163,74,0.30) 1px, transparent 1px)',
      ...
      <div
        ...
        style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle at 35% 35%, #86EFAC 0%, #166534 55%, transparent 72%)',
          filter: 'blur(28px)',
          opacity: 0.25,
      ...
      <div
        ...
        style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, #6EE7B7 0%, #059669 60%, transparent 80%)',
          filter: 'blur(18px)',
          opacity: 0.20,
        }}
        aria-hidden="true"
      ...
      <div
        ...
        style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, #D9F99D 0%, #65A30D 70%, transparent 90%)',
          filter: 'blur(12px)',
          opacity: 0.16,
          ...
          >
            ...
            <div
              style={{
                ...
                boxShadow: '0 0 6px rgba(101,163,13,0.45)',
              }}
            />
          </div>
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: 20,
                boxShadow: [
                  '0 20px 60px rgba(22,163,74,0.40)',
