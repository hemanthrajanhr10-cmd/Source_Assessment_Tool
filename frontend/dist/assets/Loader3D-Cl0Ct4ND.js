import{r as i,j as e,h as c}from"./index-O3hYLF9N.js";function b({message:r="Loading…",size:s="md"}){const[o,n]=i.useState(!1);i.useEffect(()=>{const a=setTimeout(()=>n(!0),20);return()=>clearTimeout(a)},[]);const t=s==="sm"?.6:s==="lg"?1.3:1;return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
