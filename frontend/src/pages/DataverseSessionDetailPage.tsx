                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {c.recommendation && (
                    <div style={{
                      ...
                      background: 'rgba(77,168,160,0.05)', border: `1px solid ${T.light200}`,
  ...
  return (
    <div style={{ background: '#fff', borderRadius: '20px', overflow: 'hidden', boxShadow: T.shadowCard, border: `1px solid ${T.light100}` }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '12px', fontWeight: 600, color: T.textMid, margin: 0 }}>
      ...
      <div ref={termRef} style={{
        ...
        {jobStatus.progress_message && (
          <p style={{ color: T.accent, margin: 0 }}>
            <span style={{ color: 'rgba(77,168,160,0.55)' }}>{'> '}</span>
            {jobStatus.progress_message}
            <span style={{ animation: 'blink 1s step-end infinite', color: T.accent }}>▊</span>
          </p>
        )}
        <p style={{ color: 'rgba(77,168,160,0.45)', margin: '6px 0 0', fontSize: '11px' }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.surface }}>
      ...
      <div style={{ background: T.gradHero, padding: '24px 32px', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '-50px', right: '-50px', width: '200px', height: '200px', borderRadius: '50%', background: 'rgba(77,168,160,0.07)', pointerEvents: 'none' }} />
        ...
        <div style={{ position: 'relative' }}>
          <button
            ...
            style={{
              ...
              fontSize: '12px', fontWeight: 600, color: T.textMid,
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              {result ? (
                <div style={{
                  ...
                  background: `conic-gradient(${scoreColor} ${score * 3.6}deg, ${T.light100} 0deg)`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  boxShadow: `0 0 0 3px ${T.light50}`,
                }}>
                  <div style={{
                    ...
                    <span style={{ fontSize: '7px', color: '#94A3B8', textTransform: 'uppercase' }}>score</span>
                  </div>
                </div>
              ) : (
                <div style={{
              ...
              <div>
                <h1 style={{ color: T.dark, fontSize: '20px', fontWeight: 700, margin: 0 }}>
                  {jobStatus?.label || result?.environment_url || 'Dataverse Assessment'}
                </h1>
                {result?.organization_name && (
                  <p style={{ color: T.textMid, fontSize: '12.5px', margin: '3px 0 0' }}>
                    {result.organization_name} · {result.environment_url}
                  </p>
                )}
                {result?.organization_version && (
                  <p style={{ color: T.primary, fontSize: '11.5px', margin: '2px 0 0' }}>
            ...
            {jobStatus && (
              <div style={{
                ...
                background: jobStatus.status === 'completed'
                  ...
                  ? 'rgba(220,38,38,0.20)'
                  : 'rgba(77,168,160,0.20)',
                border: `1px solid ${jobStatus.status === 'completed' ? 'rgba(5,150,105,0.30)' : jobStatus.status === 'failed' ? 'rgba(220,38,38,0.30)' : 'rgba(77,168,160,0.30)'}`,
              }}>
            ...
            {(['overview', 'domains', 'checks'] as const).map(tab => (
              <button
                ...
                style={{
                  ...
                  boxShadow: activeTab === tab ? '0 2px 8px rgba(77,168,160,0.25)' : 'none',
                }}
              >
