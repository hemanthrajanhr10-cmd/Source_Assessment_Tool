...
class Settings(BaseSettings):
    ...
    azure_store_server: str = "azuredb-server-ubti.database.windows.net"
    azure_store_port: int = 1433
    azure_store_database: str = "azuredb"
    azure_store_username: str = "admin11"
    azure_store_password: SecretStr = SecretStr("admin@123")
