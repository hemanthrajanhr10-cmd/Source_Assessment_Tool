  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-4 text-center">
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(22,163,74,0.05) 0%, rgba(22,163,74,0.03) 100%)',
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      >
        ...
        <div
          className="h-0.5"
          style={{ background: 'linear-gradient(90deg, #166534, #16A34A, #10B981, transparent)' }}
          aria-hidden="true"
        />
      ...
      {isRunning && (
        ...
        >
          ...
          <div className="px-6 pb-5 space-y-2">
            ...
            <div className="w-full h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(22,163,74,0.08)' }}>
              <div
